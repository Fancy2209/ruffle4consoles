...
cargo build -Z json-target-spec -Z build-std=core,alloc,std,panic_abort --cfg getrandom_backend="rndr" --target aarch64-nintendo-switch.json --profile=switch -Zthreads=$(nproc) -v
